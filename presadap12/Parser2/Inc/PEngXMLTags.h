...
_LIT8( KTransactionContentNS_CSP13, "http://www.openmobilealliance.org/DTD/IMPS-TRC1.3" );
...
_LIT8( KPresenceSubListAttributesNS_CSP13, "http://www.openmobilealliance.org/DTD/IMPS-PA1.3" );
...
// 1.3 specific tags
_LIT8( KUserIDList, "UserIDList" );
_LIT8( KContactListIDList, "ContactListIDList" );
_LIT8( KClientID, "ClientID" );
_LIT8( KNotificationRequest, "Notification-Request" );
_LIT8( KNotificationType, "NotificationType" );
