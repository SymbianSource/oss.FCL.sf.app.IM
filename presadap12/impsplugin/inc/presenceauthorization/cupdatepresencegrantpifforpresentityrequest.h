...
#ifndef __CUPDATEPRESENCEGRANTPIFFORPRESENTITYREQUEST_H__
#define __CUPDATEPRESENCEGRANTPIFFORPRESENTITYREQUEST_H__
...
/**
 * CUpdatePresenceGrantPifForPresentityRequest
 *
...
class CUpdatePresenceGrantPifForPresentityRequest: public CActive
    ...
    public:
        ...
        static CUpdatePresenceGrantPifForPresentityRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUpdatePresenceGrantPifForPresentityRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUpdatePresenceGrantPifForPresentityRequest();
    ...
    public:
        ...
        void UpdatePresenceGrantPifForPresentityL(
...
#endif // __CUPDATEPRESENCEGRANTPIFFORPRESENTITYREQUEST_H__
