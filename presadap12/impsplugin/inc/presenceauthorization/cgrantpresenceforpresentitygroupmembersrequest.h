...
#ifndef __CGRANTPRESENCEFORPRESENTITYGROUPMEMBERSREQUEST_H__
#define __CGRANTPRESENCEFORPRESENTITYGROUPMEMBERSREQUEST_H__
...
/**
 * CGrantPresenceForPresentityGroupMembersRequest
 *
...
class CGrantPresenceForPresentityGroupMembersRequest: public CActive
    ...
    public:
        ...
        static CGrantPresenceForPresentityGroupMembersRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CGrantPresenceForPresentityGroupMembersRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CGrantPresenceForPresentityGroupMembersRequest();
    ...
    public:
        ...
        void GrantPresenceForPresentityGroupMembersL(
...
#endif // __CGRANTPRESENCEFORPRESENTITYGROUPMEMBERSREQUEST_H__
