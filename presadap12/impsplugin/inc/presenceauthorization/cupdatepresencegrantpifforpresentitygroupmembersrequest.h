...
#ifndef __CUPDATEPRESENCEGRANTPIFFORPRESENTITYGROUPMEMBERSREQUEST_H__
#define __CUPDATEPRESENCEGRANTPIFFORPRESENTITYGROUPMEMBERSREQUEST_H__
...
/**
 * CUpdatePresenceGrantPifForPresentityGroupMembersRequest
 *
...
class CUpdatePresenceGrantPifForPresentityGroupMembersRequest: public CActive
    ...
    public:
        ...
        static CUpdatePresenceGrantPifForPresentityGroupMembersRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUpdatePresenceGrantPifForPresentityGroupMembersRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUpdatePresenceGrantPifForPresentityGroupMembersRequest();
    ...
    public:
        ...
        void UpdatePresenceGrantPifForPresentityGroupMembersL(
...
#endif // __CUPDATEPRESENCEGRANTPIFFORPRESENTITYGROUPMEMBERSREQUEST_H__
