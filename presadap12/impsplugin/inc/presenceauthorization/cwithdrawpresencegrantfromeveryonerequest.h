...
#ifndef __CWITHDRAWPRESENCEGRANTFROMEVERYONEREQUEST_H__
#define __CWITHDRAWPRESENCEGRANTFROMEVERYONEREQUEST_H__
...
/**
 * CWithdrawPresenceGrantFromEveryoneRequest
 *
...
class CWithdrawPresenceGrantFromEveryoneRequest: public CActive
    ...
    public:
        ...
        static CWithdrawPresenceGrantFromEveryoneRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CWithdrawPresenceGrantFromEveryoneRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CWithdrawPresenceGrantFromEveryoneRequest();
    ...
    public:
        ...
        void WithdrawPresenceGrantFromEveryoneL();
...
#endif // __CWITHDRAWPRESENCEGRANTFROMEVERYONEREQUEST_H__
