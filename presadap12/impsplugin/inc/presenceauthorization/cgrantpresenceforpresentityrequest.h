...
#ifndef __CGRANTPRESENCEFORPRESENTITYREQUEST_H__
#define __CGRANTPRESENCEFORPRESENTITYREQUEST_H__
...
/**
 * CGrantPresenceForPresentityRequest
 *
...
class CGrantPresenceForPresentityRequest: public CActive
    ...
    public:
        ...
        static CGrantPresenceForPresentityRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CGrantPresenceForPresentityRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CGrantPresenceForPresentityRequest();
...
#endif // __CGRANTPRESENCEFORPRESENTITYREQUEST_H__
