...
#ifndef __CUPDATEPRESENCEGRANTPIFFOREVERYONEREQUEST_H__
#define __CUPDATEPRESENCEGRANTPIFFOREVERYONEREQUEST_H__
...
/**
 * CUpdatePresenceGrantPifForEveryoneRequest
 *
...
class CUpdatePresenceGrantPifForEveryoneRequest: public CActive
    ...
    public:
        ...
        static CUpdatePresenceGrantPifForEveryoneRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUpdatePresenceGrantPifForEveryoneRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUpdatePresenceGrantPifForEveryoneRequest();
    ...
    public:
        ...
        void UpdatePresenceGrantPifForEveryoneL( const MPresenceInfoFilter& aPif );
...
#endif // __CUPDATEPRESENCEGRANTPIFFOREVERYONEREQUEST_H__
