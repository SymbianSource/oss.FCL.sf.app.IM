...
#ifndef __CUNSUBSCRIBEPRESENCEGRANTREQUESTLISTREQUEST_H__
#define __CUNSUBSCRIBEPRESENCEGRANTREQUESTLISTREQUEST_H__
...
/**
 * CUnsubscribePresenceGrantRequestListRequest
 *
...
class CUnsubscribePresenceGrantRequestListRequest: public CActive
    ...
    public:
        ...
        static CUnsubscribePresenceGrantRequestListRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUnsubscribePresenceGrantRequestListRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUnsubscribePresenceGrantRequestListRequest();
    ...
    public:
        ...
        void UnsubscribePresenceGrantRequestListL();
...
#endif // __CUNSUBSCRIBEPRESENCEGRANTREQUESTLISTREQUEST_H__
