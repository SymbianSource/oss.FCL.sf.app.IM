...
#ifndef __CCANCELPRESENCEBLOCKFROMPRESENTITYREQUEST_H__
#define __CCANCELPRESENCEBLOCKFROMPRESENTITYREQUEST_H__
...
/**
 * CCancelPresenceBlockFromPresentityRequest
 *
...
class CCancelPresenceBlockFromPresentityRequest: public CActive
    ...
    public:
        ...
        static CCancelPresenceBlockFromPresentityRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CCancelPresenceBlockFromPresentityRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CCancelPresenceBlockFromPresentityRequest();
    ...
    public:
        ...
        void CancelPresenceBlockFromPresentityL(
...
#endif // __CCANCELPRESENCEBLOCKFROMPRESENTITYREQUEST_H__
