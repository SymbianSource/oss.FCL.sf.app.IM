...
#ifndef __CWITHDRAWPRESENCEGRANTFROMPRESENTITYGROUPMEMBERSREQUEST_H__
#define __CWITHDRAWPRESENCEGRANTFROMPRESENTITYGROUPMEMBERSREQUEST_H__
...
/**
 * CWithdrawPresenceGrantFromPresentityGroupMembersRequest
 *
...
class CWithdrawPresenceGrantFromPresentityGroupMembersRequest: public CActive
    ...
    public:
        ...
        static CWithdrawPresenceGrantFromPresentityGroupMembersRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CWithdrawPresenceGrantFromPresentityGroupMembersRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CWithdrawPresenceGrantFromPresentityGroupMembersRequest();
    ...
    public:
        ...
        void WithdrawPresenceGrantFromPresentityGroupMembersL(
...
#endif // __CWITHDRAWPRESENCEGRANTFROMPRESENTITYGROUPMEMBERSREQUEST_H__
