...
#ifndef __CUNSUBSCRIBEPRESENCEBLOCKLISTREQUEST_H__
#define __CUNSUBSCRIBEPRESENCEBLOCKLISTREQUEST_H__
...
/**
 * CUnsubscribePresenceBlockListRequest
 *
...
class CUnsubscribePresenceBlockListRequest: public CActive
    ...
    public:
        ...
        static CUnsubscribePresenceBlockListRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUnsubscribePresenceBlockListRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUnsubscribePresenceBlockListRequest();
    ...
    public:
        ...
        void UnsubscribePresenceBlockListL();
...
#endif // __CUNSUBSCRIBEPRESENCEBLOCKLISTREQUEST_H__
