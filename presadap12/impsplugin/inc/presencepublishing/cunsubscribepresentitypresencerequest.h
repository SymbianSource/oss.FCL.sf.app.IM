...
#ifndef __CUNSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
#define __CUNSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
...
/**
 * CUnsubscribePresentityPresenceRequest
 *
...
class CUnsubscribePresentityPresenceRequest: public CActive
    ...
    public:
        ...
        static CUnsubscribePresentityPresenceRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUnsubscribePresentityPresenceRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUnsubscribePresentityPresenceRequest();
    ...
    public:
        ...
        void UnsubscribePresentityPresenceL( const MXIMPIdentity& aIdentity );
...
#endif // __CUNSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
