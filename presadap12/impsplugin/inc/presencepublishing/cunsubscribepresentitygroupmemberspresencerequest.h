...
#ifndef __CUNSUBSCRIBEPRESENTITYGROUPMEMBERSPRESENCEREQUEST_H__
#define __CUNSUBSCRIBEPRESENTITYGROUPMEMBERSPRESENCEREQUEST_H__
...
class CUnSubscribePresentityGroupMembersPresenceRequest: public CActive
    ...
    public:
        ...
        static CUnSubscribePresentityGroupMembersPresenceRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUnSubscribePresentityGroupMembersPresenceRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUnSubscribePresentityGroupMembersPresenceRequest();
    ...
    public:
        ...
        void UnsubscribePresentityGroupMembersPresenceL( const MXIMPIdentity& aIdentity );
...
#endif // __CUNSUBSCRIBEPRESENTITYGROUPMEMBERSPRESENCEREQUEST_H__
