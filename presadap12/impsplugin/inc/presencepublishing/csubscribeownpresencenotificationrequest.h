...
#ifndef __CSUBSCRIBEOWNPRESENCENOTIFICATIONREQUEST_H__
#define __CSUBSCRIBEOWNPRESENCENOTIFICATIONREQUEST_H__
...
/**
 * CSubscribeOwnPresenceNotificationRequest
 *
...
class CSubscribeOwnPresenceNotificationRequest: public CActive
    ...
    public:
        ...
        static CSubscribeOwnPresenceNotificationRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CSubscribeOwnPresenceNotificationRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CSubscribeOwnPresenceNotificationRequest();
    ...
    public:
        ...
        void MakeSubscribeOwnPresenceNotificationActiveL();
...
#endif // __CSUBSCRIBEOWNPRESENCENOTIFICATIONREQUEST_H__
