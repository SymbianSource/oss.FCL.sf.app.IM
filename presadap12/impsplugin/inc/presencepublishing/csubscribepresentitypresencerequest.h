...
#ifndef __CSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
#define __CSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
...
/**
 * CSubscribePresentityPresenceRequest
 *
...
class CSubscribePresentityPresenceRequest: public CActive
    ...
    public:
        ...
        static CSubscribePresentityPresenceRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CSubscribePresentityPresenceRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CSubscribePresentityPresenceRequest();
    ...
    public:
        ...
        void SubscribePresentityPresenceL(
...
#endif // __CSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
