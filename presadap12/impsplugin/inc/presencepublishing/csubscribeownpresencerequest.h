...
#ifndef __CSUBSCRIBEOWNPRESENCEREQUEST_H__
#define __CSUBSCRIBEOWNPRESENCEREQUEST_H__
...
class CSubscribeOwnPresenceRequest: public CActive
    ...
    public:
        ...
        static CSubscribeOwnPresenceRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CSubscribeOwnPresenceRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CSubscribeOwnPresenceRequest();
    ...
    public:
        ...
        void SubscribeOwnPresenceL( const MPresenceInfoFilter& aPif );
...
#endif // __CSUBSCRIBEOWNPRESENCEREQUEST_H__
