...
#ifndef __CIMPSPLUGINCWATCHUNSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
#define __CIMPSPLUGINCWATCHUNSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
...
/**
 * CUnsubscribePresentityPresence
 *
...
class CUnsubscribePresentityPresence: public CActive
    ...
    public:
        ...
        static CUnsubscribePresentityPresence* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUnsubscribePresentityPresence* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUnsubscribePresentityPresence();
    ...
    public:
        ...
        void UnsubscribePresentityPresenceRequestL( const TDesC& aContactId );
...
#endif // __CIMPSPLUGINCWATCHUNSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
