...
#ifndef __CIMPSPLUGINCWATCHUPDATEPRESENTITYPRESENCEREQUEST_H__
#define __CIMPSPLUGINCWATCHUPDATEPRESENTITYPRESENCEREQUEST_H__
...
class CUpdatePresentityPresence: public CActive
    ...
    public:
        ...
        static CUpdatePresentityPresence* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUpdatePresentityPresence* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUpdatePresentityPresence();
    ...
    public:
        ...
        void UpdatePresentityPresenceRequestL( const TDesC& aContactId, const MPresenceInfoFilter& aPif );
...
#endif // __CIMPSPLUGINCWATCHUPDATEPRESENTITYPRESENCEREQUEST_H__
