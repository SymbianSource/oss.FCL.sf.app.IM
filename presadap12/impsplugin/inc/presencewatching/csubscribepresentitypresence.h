...
#ifndef __CIMPSPLUGINCWATCHSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
#define __CIMPSPLUGINCWATCHSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
...
class CSubscribePresentityPresence: public CActive
    ...
    public:
        ...
        static CSubscribePresentityPresence* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CSubscribePresentityPresence* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CSubscribePresentityPresence();
    ...
    public:
        ...
        void SubscribePresentityPresenceRequestL( const TDesC& aContactId, const MPresenceInfoFilter& aPif );
...
#endif // __CIMPSPLUGINCWATCHSUBSCRIBEPRESENTITYPRESENCEREQUEST_H__
