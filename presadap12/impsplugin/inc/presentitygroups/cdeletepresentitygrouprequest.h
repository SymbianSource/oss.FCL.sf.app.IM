...
#ifndef __CIMPSPLUGINDELETEPRESENTITYGROUPREQUEST_H__
#define __CIMPSPLUGINDELETEPRESENTITYGROUPREQUEST_H__
...
/**
 * CDeletePresentityGroupRequest
 *
 * Delete Presentity Group Request to Network Server
 *
 * @lib ?library
 * @since S60 v4.0
 */

class CDeletePresentityGroupRequest: public CActive
    ...
    public:
        ...
        static CDeletePresentityGroupRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CDeletePresentityGroupRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CDeletePresentityGroupRequest();
    ...
    public:
        ...
        void DeletePresentityGroupRequestL( const MXIMPIdentity& aIdentity );
    ...
    private: // data
        ...
        /**
         * Store the groupName as the data member
         */
        HBufC16* iGroupName;
...
#endif // __CIMPSPLUGINDELETEPRESENTITYGROUPREQUEST_H__
