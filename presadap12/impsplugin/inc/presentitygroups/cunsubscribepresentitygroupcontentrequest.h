...
#ifndef __CUNSUBSCRIBEPRESENTITYGROUPCONTENTREQUEST_H__
#define __CUNSUBSCRIBEPRESENTITYGROUPCONTENTREQUEST_H__
...
/**
 * CUnSubscribePresentityGroupContentRequest
 *
...
class CUnSubscribePresentityGroupContentRequest: public CActive
    ...
    public:
        ...
        static CUnSubscribePresentityGroupContentRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUnSubscribePresentityGroupContentRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUnSubscribePresentityGroupContentRequest();
    ...
    public:
        ...
        void UnSubscribePresentityGroupContentL(
...
#endif // __CUNSUBSCRIBEPRESENTITYGROUPCONTENTREQUEST_H__
