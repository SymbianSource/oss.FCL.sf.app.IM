...
#ifndef __CIMPSPLUGINSUBSCRIBEPRESENTITYGROUPLISTREQUEST_H__
...
/**
 * CSubscribePresentityGroupListRequest
 *
...
class CSubscribePresentityGroupListRequest: public CActive
    ...
    public:
        ...
        static CSubscribePresentityGroupListRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CSubscribePresentityGroupListRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CSubscribePresentityGroupListRequest();
    ...
    public:
        ...
        void SubscribePresentityGroupListRequestL();
...
#endif // __CIMPSPLUGINSUBSCRIBEPRESENTITYGROUPLISTREQUEST_H__
