...
#ifndef __CUPDATEPRESENTITYGROUPMEMBERDISPLAYNAMEREQUEST_H__
#define __CUPDATEPRESENTITYGROUPMEMBERDISPLAYNAMEREQUEST_H__
...
/**
 * CUpdatePresentityGroupMemberDisplayNameRequest
 *
...
class CUpdatePresentityGroupMemberDisplayNameRequest: public CActive
    ...
    public:
        ...
        static CUpdatePresentityGroupMemberDisplayNameRequest* NewL(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        static CUpdatePresentityGroupMemberDisplayNameRequest* NewLC(
            MImpsPrtPluginConnectionManager& aConnMan,
            TXIMPRequestId aRequestId );

        virtual ~CUpdatePresentityGroupMemberDisplayNameRequest();
    ...
    public:
        ...
        void UpdatePresentityGroupMemberDisplayNameL(
...
#endif // __CUPDATEPRESENTITYGROUPMEMBERDISPLAYNAMEREQUEST_H__
