...
* Contributors:
*
* Description:  WV Alias attribute constructor.
*
*/

#ifndef CPENGWVALIASCONSTRUCT_H
#define CPENGWVALIASCONSTRUCT_H
...
/**
 * WV Alias attribute constructor.
 *
 * @lib PEngAttrLib
 * @since 3.0
 */
NONSHARABLE_CLASS( CPEngWVAliasConstruct ) : public CPEngWVAttributeConstructBase
    {
public:  // Constructors and destructor
     ...
     * C++ constructor.
     */
    CPEngWVAliasConstruct( TPEngWVCspVersion aCurrentCspVer );


    /**
     * Destructor.
     */
    virtual ~CPEngWVAliasConstruct();
...
public: //Attribute model implementation
    ...
    /**
     * WV Alias attribute implementation.
     *
     * @lib PEngAttrLib
     * @since 3.0
     */
    NONSHARABLE_CLASS( CPEngWVAliasModel ) : public CPEngWVAttributeModelBase
        {
public:  // Constructors and destructor
         ...
         * C++ constructor.
         */
        CPEngWVAliasModel( TBool aUserOwnAttribute );
