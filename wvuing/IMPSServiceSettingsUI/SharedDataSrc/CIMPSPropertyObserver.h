...
#ifndef CIMPSPROPERTYOBSERVER_H
#define CIMPSPROPERTYOBSERVER_H
...
*  @since 2.6
*/
NONSHARABLE_CLASS( CIMPSPropertyObserver ) : public CActive
    {
public:  // Constructors and destructor
    ...
    */
    static CIMPSPropertyObserver* NewL( MIMPSPropertyNotificationObserver& aObserver );
...
private:
    ...
    */
    CIMPSPropertyObserver( MIMPSPropertyNotificationObserver& aObserver );
