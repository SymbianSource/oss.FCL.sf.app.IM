...
* Contributors:
*
* Description:  Central repository handler for IMPSCommonUI
*
*/

#ifndef __CIMPSCENREPHANDLER_H
#define __CIMPSCENREPHANDLER_H
...
*  @since 2.6
*/
NONSHARABLE_CLASS( CIMPSCenrepHandler ) : public CBase,
...
public: // New functions
    ...
    */
    static CIMPSCenrepHandler* NewL( MIMPSSharedDataObserver* aObserver, const TUid aUid );
...
private: // constructor and destructor
    ...
    */
    CIMPSCenrepHandler( MIMPSSharedDataObserver* aObserver );
...
private:    // Data
    ...
    RPointerArray<CIMPSCenrepObserver> iCenrepObservers;

    //Array of key pairs
    RArray<TIMPSSharedKeyPairs> iKeys;

    // Owns: central repository
    CRepository*			iRepository;
    };

#endif      // __CIMPSCENREPHANDLER_H
